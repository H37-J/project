package com.hjk.shopboot.utils.web;

import java.util.ArrayList;
import java.util.List;
import java.util.regex.Pattern;

import com.hjk.shopboot.utils.javautils.StrUtils;
...
public enum OperatingSystem {
    ...
    private OperatingSystem(Manufacturer manufacturer, OperatingSystem parent, int versionId, String name,
        ...
        this.name = name;
        this.aliases = StrUtils.toLowercase(aliases);
        this.excludeList = StrUtils.toLowercase(exclude);
    ...
    private boolean isInUserAgentStringLowercase(final String agentLowerCaseString) {
        return StrUtils.contains(agentLowerCaseString, aliases);
    }
    ...
    private boolean containsExcludeTokenLowercase(final String agentLowerCaseString) {
        return StrUtils.contains(agentLowerCaseString, excludeList);
    }
