...
license your work under the the terms of the [MIT License](Desktop/SpringProject2 (1) (1)/web/WEB-INF/resources/assets/admin-template/vendor/noty/docs/v2/vendor/noty-2.4.1/LICENSE.txt).
