        ...
        initCountQty: function() {
            ...
            this.collection.each(function(i, el) {
                ...
                $plus.on('click', function(e) {
                    ...
                    let pid=($this[0].getAttribute('value'));
                    let rem = document.getElementById(`${pid}rem`).textContent;

                    var stock = document.getElementById(`${pid}stock`).value;
                    console.log(stock);
                    stock = parseInt(stock) + 1;
                    if (stock > rem) { alert('더 이상 재고가 없습니다'); return false; }
