const getObjectPropertyValueByKey = (obj: any, key: string): any | undefined => {
...
const getUniqueIdWithPrefix = (prefix: string | undefined): string => {
...
const stringSnakeToCamel = (str: string): string => {
  return str.replace(/(\-\w)/g, function (m) {
    return m[1].toUpperCase()
  })
}

const toJSON = (value: string | JSON): JSON | undefined => {
