...
(function($, document, Math, undefined) {
    ...
    setInterval(function () {
        ...
        var randomTwo = Math.round(Math.random() * 10);
        var valuesTwo = updatingChartTwo.text().split(",");
        valuesTwo.shift();
        valuesTwo.push(randomTwo);

        updatingChartTwo.text(valuesTwo.join(",")).change();

        var randomThree = Math.round(Math.random() * 10);
        var valuesThree = updatingChartThree.text().split(",");
        valuesThree.shift();
        valuesThree.push(randomThree);

        updatingChartThree.text(valuesThree.join(",")).change();
    }, 1000);
